...
export function serviceConversationIssues(data: Record<string, unknown>) {
  const issues: string[] = [];
  ...
  if (maintenance !== undefined) {
    ...
    else if ((maintenance as Record<string, unknown>).basicConversation !== undefined &&
      (maintenance as Record<string, unknown>).basicConversation !== true)
