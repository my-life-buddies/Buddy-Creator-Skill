...
export type TargetStatus = "unstarted" | "partial" | "sufficient" | "uncertain" | "skipped" | "exhausted" | "conflict";
export type Target = {
    id: string;
    cycleId: string;
    status: TargetStatus;
...
export type WorkResult = {
    intent: "answer" | "supplement" | "revise" | "confirm" | "explain" | "pause" | "skip" | "correct_question" | "resume";
...
export type WorkKind = "interview_turn" | "source_process" | "knowledge_synthesis" | "artifact_draft" | "artifact_revision" | "conflict_review" | "delivery_compose";
